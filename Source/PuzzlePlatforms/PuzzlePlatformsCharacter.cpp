...
void APuzzlePlatformsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Popup Menu
	PlayerInputComponent->BindAction("PopupMenu", IE_Pressed, this, &APuzzlePlatformsCharacter::ShowHidePopupMenu);
}
